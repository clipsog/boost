...
- **Full pack:** views tiered by current video likes — 0 → 480 · 1–7 → 541 · 8–19 → 650 · ≥20 → 750; always sends 10–14 likes (988)
- **Lower boost:** 300 views (953) + 10 likes (988)
- **Views only:** custom views (953, min 100)
- **Likes only:** custom likes (988, min 10)
